    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('q3', models.CharField(choices=[('1', 'No'), ('2', 'Hobby'), ('3', 'Professional')], default='', max_length=50)),
                ('q4', models.CharField(choices=[('1', 'No'), ('2', 'Hobby'), ('3', 'Professional')], default='', max_length=50)),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='Creation date')),
            ],
        ),
        migrations.CreateModel(
